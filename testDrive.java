...
public class testDrive {
    public static void main(String[] args) throws ParseException {
        ...
        HangHoa sp1 = new HangThucPham("100", "Rau Cai", 15000 ,1231, "22/11/2023","25/11/2021");
        HangHoa sp2 = new HangThucPham("101", "Ca thu", 150000 ,893, "29/12/2022","01/01/2022");
        ...
        HangHoa sp7 = new HangSanhSu("100", "Chen Tra", 50000, 235, "20/11/2014", "Bat Trang");
        HangHoa sp8 = new HangSanhSu("101", "Chen Com", 55000, 940, "19/11/2012", "TP HCM");
        ...
        HangHoa sp12 = new HangSanhSu("105", "To Su", 700000, 621, "30/04/2010", "Long An");
        HangHoa sp13 = new HangSanhSu("106", "Am Su", 800000, 1225, "20/12/2015", "Bat Trang");
        //************************************************************************************/
        //TẠO ĐỐI TƯỢNG HÀNG ĐIỆN MÁY
        //HangHoa x = new HangDienMay(maHang, tenHangHoa, giaNhap, soLuongTonKho, ngayNhapKho, congSuat)
        HangHoa sp14 = new HangDienMay("100", "May Lanh", 10000000, 55,"20/11/2017", 500);
        HangHoa sp15 = new HangDienMay("101", "May Giat", 15000000, 46,"23/03/2016", 700);
        HangHoa sp16 = new HangDienMay("102", "May Say", 899000, 23,"17/07/2024", 250);
        HangHoa sp17 = new HangDienMay("103", "May Xay Sinh To", 1299000, 39,"20/11/2027", 1000);
        HangHoa sp18 = new HangDienMay("104", "May Suoi", 2355000, 42,"16/12/2025", 1500);
        HangHoa sp19 = new HangDienMay("105", "May Quat", 490000, 15,"26/06/2009", 125);
        HangHoa sp20 = new HangDienMay("106", "May Loc Nuoc", 12500000, 66,"15/05/2002", 100);
        //************************************************************************************/
